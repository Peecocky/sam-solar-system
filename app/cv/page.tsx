...
// Keep the original CV presentation and interaction, but replace only the
// project list with the projects from the 2026-06-02 PDF résumé.
const PDF_PROJECTS = [
  {
    title: {
      cn: '上海交通大学凯原法学院 — 涉外法治智能体与赛队网页',
      en: 'SJTU Koguan Law School — Foreign-Related Rule-of-Law Agent & Competition Team Website',
    },
    date: { cn: '2026.01 – 2026.06', en: 'Jan – Jun 2026' },
    link: '',
    hasPaper: false,
    bullets: {
      cn: [
      ...
      en: [
        'Helped build foreign-related rule-of-law and competition knowledge-base agents with Dify and RAG, covering data preprocessing, result ingestion, agent iteration, and web integration',
        'Processed historical WeChat posts, competition news, and team results; extracted event names, dates, participating teams, and outcomes into structured labels',
        'Completed three development rounds for the competition agent: baseline Q&A and knowledge-base connection, retrieval enhancement, multi-turn optimization, exception handling, and web integration',
        'Designed and developed the competition website, including its home, event showcase, and result-search pages, with frontend-agent interaction through the Dify API',
        'Contributed to legal-article ingestion rules and a document-splitting compiler that parses hierarchical docx statutes, flattens them, and tests retrieval recall',
      ],
    },
  },
  {
    title: {
      cn: '瑞银 UBS 金融精英挑战赛 2026 — 队长、AI 投研模块与汇报 PPT',
      en: 'UBS Finance Elite Challenge 2026 — Team Lead, AI Research Module & Pitch Deck',
    },
    date: { cn: '2026.03 – 2026.05', en: 'Mar – May 2026' },
    link: '',
    role: { cn: '队长', en: 'Team Leader' },
    hasPaper: false,
    bullets: {
      ...
      en: [
        'Led the team in developing an AI optical-module supply-chain pair trade: long Zhongji Innolight and short Huagong Tech',
        'Independently produced the core pitch deck, structuring the industry thesis, company comparison, valuation framework, risk matrix, and trade catalysts',
        'Designed the AI research module and a RAG-based retrieval workflow for filings and announcements with company binding, dual-track retrieval, comparative answers, and mandatory citations',
        'Used the AI system to assess 1.6T optical-module production progress, gross-margin shifts, and execution differences, making conclusions more verifiable and reproducible',
      ],
    },
  },
  {
    title: {
      cn: '航空订票系统 — 数据库期末项目',
      en: 'Airline Reservation System — Database Final Project',
    },
    date: { cn: '2026.04 – 2026.05', en: 'Apr – May 2026' },
    link: '',
    hasPaper: false,
    bullets: {
      cn: [
      ...
      en: [
        'Designed an airline reservation website for public users, customers, booking agents, and airline employees',
        'Implemented flight search, ticket purchasing, agent booking, passenger lists, spending analytics, commission statistics, and flight-status management',
        'Added role-based login access, form validation, and safeguards against duplicate purchases and overselling for a more complete and reliable workflow',
      ],
    },
  },
  {
    title: {
      cn: '地震数据可视化与 Sonification 交互系统',
      en: 'Interactive Earthquake Visualization & Sonification System',
    },
    date: { cn: '2026.04 – 2026.05', en: 'Apr – May 2026' },
    link: '',
    hasPaper: false,
    bullets: {
      ...
      en: [
        'Designed a sonification-based earthquake visualization system to address the complexity, fragmentation, and high learning curve of existing tools',
        'Implemented an interactive tutorial, 2D / 3D map switching, browsing history, and temporal-distribution playback',
        'Added brush interaction and audio probing so users can explore the temporal, spatial, and magnitude distributions of earthquake events through both sight and sound',
        'Presented the system as a data-visualization final project and received positive feedback for its interaction design and audio-assisted exploration',
      ],
    },
  },
  {
    ...
    bullets: {
      ...
      en: [
        'Built an environmental sound classifier on UrbanSound8K, addressing multi-class prediction and class imbalance',
        'Trained and compared ResNet and CRNN models on Mel-spectrogram features with an object-oriented training and evaluation pipeline',
        'Improved predictive performance through model ensembling and achieved a Kaggle ranking of 4 / 80',
      ],
    },
  },
  {
    ...
    bullets: {
      ...
      en: [
        'Built a local-network chat system with Python multithreading and led its architecture and core implementation',
        'Integrated neural-network handwriting recognition, encrypted communication, login flows, and personalized visual effects',
      ],
    },
  },
  {
    ...
    bullets: {
      cn: [
        '使用 Blender 进行原创 3D 建模与动画设计，成品发布于 YouTube 并获得良好用户反馈',
      ],
      en: [
        'Created original 3D models and animations in Blender; published the finished work on YouTube and received positive audience feedback',
      ],
    },
  },
]

DATA.sections.projects.items = PDF_PROJECTS as typeof DATA.sections.projects.items
